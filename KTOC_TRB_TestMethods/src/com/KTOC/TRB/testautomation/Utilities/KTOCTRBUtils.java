...
public class KTOCTRBUtils {
  ...
  //public static WebDriverWait wait = new WebDriverWait(driver, TIME_OUT_IN_SECONDS);

  //private final static Logger logger = Logger.getLogger(String.valueOf(KTOCNEBUtils.class));
  //Launch Browser
...
/*
  public void StartReporting(String Testcase){
    ...
    String time = Testcase+dtf.format(now).toString();
  ...
  public void MainReport(String Reportname) 
  {
  ...
  public void StartReporting(String Testcase) 
  {
    DateTimeFormatter dtf = DateTimeFormatter.ofPattern("HH:mm:ss");
    LocalDateTime now = LocalDateTime.now();
    String time = Testcase + dtf.format(now);
  }
...
/*			else if (locatorType.equalsIgnoreCase("linkText")){
  ...
  protected void WaitAndClear(String locatorValue)
  {
	  ...
	  wait.until(ExpectedConditions.visibilityOfElementLocated(By
              .xpath(locatorValue))).clear();
	  
  }

  protected void FluentWaitClick(WebElement element)
  {
	  new WebDriverWait(driver, TIME_OUT_IN_SECONDS).ignoring(StaleElementReferenceException.class).until(ExpectedConditions.elementToBeClickable(element));
	  element.click();
/*	  Wait<WebDriver> stubbornWait = new FluentWait<WebDriver>(driver)
				...
				element = stubbornWait.until(new Function<WebDriver, WebElement>() {
...
/*		    if(element.isEnabled())
        {
		    	element.sendKeys(text);
		    	logger.log(LogStatus.PASS, "The Text"+text+"is typed successfully");
		    }else
		    {
		    	logger.log(LogStatus.FAIL, "Error typing the Text:"+ text);
		    }*/
/*		    if(element.getText()!=text)
        {
		    	throw new FailToEnterValues();
		    }
		    */
  }
  ...
  protected void EnterValuesByIndex(String locator, String locatorValue, String text, int indexvalue) throws InterruptedException 
  {
    //WebDriverWait wait = new WebDriverWait(driver, TIME_OUT_IN_SECONDS);
  ...
  public static void EnterTextbyChar(String locator, String locatorValue, String text, int indexvalue) throws Exception 
  {
	  try
	  {
		  element = getWebElement(locator, locatorValue, indexvalue);
...
/*					WebDriverWait wait = new WebDriverWait(driver, 500);
  ...
  protected void SelectBootStrapCSS(String textval) {
	    WebElement listElement = driver.findElement(By.cssSelector("div.Select-menu-outer and text()='" + textval + "'"));
	    ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", listElement);
	    listElement.click();
  ...
  protected String SelectFirstTextFromDropdown(String locatorType, String locatorValue,String item1LocatorType,String itemLocatorValue)
  {
	    if (locatorType.equalsIgnoreCase("cssSelector")) {
	    	element = driver.findElement(By.cssSelector(locatorValue));
	      } else if (locatorType.equalsIgnoreCase("xpath")) {
