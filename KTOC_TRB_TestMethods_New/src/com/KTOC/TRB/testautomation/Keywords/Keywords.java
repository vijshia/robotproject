...
public class Keywords extends KTOCTRBUtils {
	...
	public void logintoSalesforce() throws Exception {
		try {
			//Implemented in KCC			
			WaitTillVisible("id", txt_userName_New);
			EnterValues("id", txt_userName_New, username);
			EnterValues("id", txt_password_New, password);
			ClickOnElement("id", btn_login_New);
			
			/*//Current Implementation in KTOC-TRB
...
//			By lnk_selectOpportunity = By.xpath("(//*[@title='" + opportunity + "'])[last()]");
			...
			if (opportunityCreateorSearch.equalsIgnoreCase("search")) {
				if (!searchBox.getAttribute("title").equals("Search Salesforce")) {
					WaitTillVisible("xpath", lnk_toLigntning_New);
					ClickOnElement("xpath",lnk_toLigntning_New);
					WaitTillVisible("xpath", txt_ligtningHomeSearchbox_New);
					System.out.println("ligtning HomePage displayed");
				}
				EnterValues("xpath", txt_searchBox_New, opportunity);
				System.out.println("Opportunity Name:" + opportunity + " entered in Search box");
				enteringValues(txt_searchBox, Keys.RETURN);
				WaitTillVisible("xpath", "(//*[@title='" + opportunity + "'])[last()]");
				ClickOnElement("xpath", "(//*[@title='" + opportunity + "'])[last()]");
				System.out.println(opportunity + " has been clicked");
				WaitTillVisible("xpath", header_flTender_New);
				WaitTillVisible("xpath", header_flTender_New);
				ClickOnElement("xpath", header_flTender_New);
//				System.out.println("clicked on FL Tenders header in Opportunity");
				WaitTillVisible("xpath", btn_flTender_New);
				ClickOnElement("xpath", btn_flTender_New);
//				System.out.println("clicked on New FLTender button in FL Tender page");
			} else {
				if (!searchBox.getAttribute("title").equals("Search...")) {
					WaitTillVisible("xpath", img_toClassic_New);
					ClickOnElement("xpath", img_toClassic_New);
					WaitTillVisible("xpath", lnk_toClassic_New);
					ClickOnElement("xpath", lnk_toClassic_New);
					WaitTillVisible("xpath", txt_classicHomeSearchbox_New);
...
//			By radio_ProductRelease = By.xpath("//*[text()='Product release for " + ProductRelease + "']/..//img[2]");
			...
			if (!frontlineAssigned.equals("CANADA")) {
				ClickOnElement("xpath", "//*[text()='Product release for " + ProductRelease + "']/..//img[2]");
...
//			clickonButton(txt_CustomerID);
			if (!isMultipleEquipment) {
				...
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", lookup_EquipmentID_New);
				System.out.println("Equipment loader clicked");
				WaitTillVisible("xpath", header_AddNewEquipment_New);
				WaitTillVisible("xpath", "//*[text()='" + equipmentid + "']/..//img");
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", "//*[text()='" + equipmentid + "']/..//img");
...
//			e.printStackTrace();
	...
	public void searchEquipmentinAddNewEquipmentLookup() throws Exception {
		try {
			WaitTillVisible("xpath", txt_EquipmentIDPopUpT_New);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			gettingWebElement(txt_EquipmentIDPopUpT).clear();
			EnterValues("xpath", txt_EquipmentIDPopUpT_New, equipmentid);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", lnk_SearchEquipment_New);
		} catch (Exception e) {
//			e.printStackTrace();
...
//			e.printStackTrace();
	...
	public void selectProjectTree() throws Exception {
		try {
			...
			WaitTillVisible("xpath", "//*[text()='" + equipmentid + "']/../..//div/div[text()='Project']");
...
//			System.out.println("scroll UP to Project tree");
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[text()='" + equipmentid + "']/../..//div/div[text()='Project']");
...
//			System.out.println("MS5HODate_Current Cleared");
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[@data-ctcwgtname='DateTenderPriceReference']");
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			...
			if(browser.equalsIgnoreCase("ch")) {
				...
				if(gettingWebElement(txt_DateHandoverMS5).getAttribute("value").isEmpty()) {
					waitForinvisibilityOfElementLocated(elementtoInvisible);
					EnterValues("xpath", txt_DateHandoverMS5_New, MS5HODate_toChange);
				}
			} else {
...
//		System.out.println("***checkSalesOfficeisSelected_salesoffice="+salesoffice+"|"+value_salesOffice);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", dd_salesOffice_New); // *[@data-ctcwgtname='SalesOffice']/button
...
//			e.printStackTrace();
	...
	public void additionalfieldsinProjectOverviewforCanada() throws Exception {
		try {
			if (frontlineAssigned.equals("CANADA")) {
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", dd_seismicArea_New);
				waitForinvisibilityOfElementLocated(elementtoInvisible);
//					System.out.println(gettingWebElement(By.xpath("//div[text()='"+value_seismicArea+"']")).getAttribute("id"));
			...
			System.out.println(value_seismicArea + " selected in SeismicArea");
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				EnterValues("xpath", txt_weeklyTeamCostforZone_New, weeklyTeamCostforZone);
//			System.out.println(weeklyTeamCostforZone+" value entered in weeklyTeamCostforZone");
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				EnterValues("xpath", txt_weeklyTeamCostforRoomandBoard_New, weeklyTeamCostforRoomandBoard);
//			System.out.println(weeklyTeamCostforRoomandBoard+" value entered in weeklyTeamCostforRoomandBoard");
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", txt_numberOfCrews_New);
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", txt_numberOfCrews_New);
...
//			System.out.println("Equipment clicked back");
			if (frontlineAssigned.equals("AUSTRALIA")) {
				...
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				EnterValues("xpath", txt_CustomerID_New, customerid);
...
//			e.printStackTrace();
	...
	public void selectEquipmentInService() throws Exception {
		try {
			...
			ClickOnElement("xpath", "//div/div[text()='" + equipmentinService + "']");
			...
			if (frontlineAssigned.equals("FRANCE") && !equipmentinService.contains("Escalator")) {
				...
				ClickOnElement("xpath", radio_hydeaulicElevator_New);
...
//			System.out.println("Equipment identified for RightClick");
			...
			if (isMultipleEquipment) {
				...
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", txt_searchTemplate_New);
			}
			WaitTillVisible("xpath", "(//*[text()='" + template + "'])[last()]");
...
//		pricingIconClick();
		WaitTillVisible("xpath", tab_priceOverview_New);
		waitForinvisibilityOfElementLocated(elementtoInvisible);
		ClickOnElement("xpath", tab_priceOverview_New);
		selectingFirstMaintenance(FirstMaintenance);
		GetTargetPrice();
		selectingDiscount(discount);
	...
	public void VerifyCostCalculatedSuccessfully() throws Exception {
		try {
			if (frontlineAssigned.equals("AUSTRALIA")) {
				...
				WaitTillVisible("xpath", tab_detailBreakDown_New);
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", tab_detailBreakDown_New);
...
//			e.printStackTrace();
	...
	public void clickonCurrenciesTab() throws Exception {
		try {
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", tab_Currencies_New);
...
//			e.printStackTrace();
	...
	public void getConversionFactor() throws Exception {
		try {
			WaitTillVisible("xpath", value_ConversionFactor_New);
...
//			e.printStackTrace();
	...
	public void clickonAdditionalDiscountIcon() throws Exception {
		try {
			WaitTillVisible("xpath", tab_priceOverview_New); //By.xpath("//*[text()='Price overview']")
...
//			e.printStackTrace();
	...
	public void getRegionalDiscount(String firstMaintenance) throws Exception {
		try {
			WaitTillVisible("xpath", grid_RegionalDiscountValues_New);
...
//			e.printStackTrace();
	...
	public void gotoDetailBreakdownTab() throws Exception {
		try {
			...
			WaitTillVisible("xpath", dd_selectProject_New);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", dd_selectProject_New);
			WebElement element_Ropes = gettingWebElement(value_ropes);
			WaitTillVisible("xpath", value_ropes_New);
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='Toolbar' and @data-ctctype='Toolbar']/div");
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			gettingWebElementsfromList(By.xpath("//*[@data-ctcwgtname='Toolbar' and @data-ctctype='Toolbar']/div"))
					.get(4).click();
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='Toolbar' and @data-ctctype='Toolbar']/div");
			WaitTillVisible("xpath", header_ITEfactor_New);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
...
//			System.out.println(button.getAttribute("id"));
			...
			WaitTillVisible("xpath", "//*[text()='Reference hours']");
		} catch (Exception e) {
//			e.printStackTrace();
...
//				System.out.println(elementToWord.getAttribute("id"));
			...
			WaitTillVisible("xpath", label_KONELogo_New);
...
//			e.printStackTrace();
	...
	public void verifySuccessfulMessageDisplayed() throws Exception {
		try {
			...
			WebElement element_PrintOut = gettingWebElement(icon_printOut); 
			...
			if (frontlineAssigned.equals("FRANCE")) {
				WaitTillVisible("xpath", text_freezePrint_New);
			...
			WaitTillVisible("xpath", text_infotoDocServer_New);
...
//			By value_stage = By.xpath("//div[text()='" + StageProbability_Stage + "']");
			...
			WaitTillVisible("xpath", icon_saveandClose_New);
			waitForElementToBeClickable(icon_saveandClose);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", icon_saveandClose_New);
			System.out.println("SaveandClose icon CLICKED");
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='pb" + SaveandClose + "']");
			click_Javascript(gettingWebElement(btn_saveandClose));
			System.out.println(SaveandClose + " CLICKED in SaveandClose");
			WaitTillVisible("xpath", txt_stageProbabilityDescription_New);
			EnterValues("xpath", txt_stageProbabilityDescription_New, StageProbability_Description);
			System.out.println(
					StageProbability_Description + " entered in Description field in stage / Probability window");
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", dd_stage_New);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//div[text()='" + StageProbability_Stage + "']");
/*			WebElement element_enderVersionProbability = gettingWebElement(txt_probability);
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", btn_stageProbability_New);
...
//					By btn_updateFailedOK = By.xpath("//*[text()='OK']");
				...
				WaitTillVisible("xpath", "//*[@data-ctcwgtname='ToolBar' and @data-ctctype='Toolbar']/div[1]");
				scrollIntoView_Javascript(gettingWebElement(icon_Close));
				waitForinvisibilityOfElementLocated(elementtoInvisible);
				ClickOnElement("xpath", "//*[@data-ctcwgtname='ToolBar' and @data-ctctype='Toolbar']/div[1]");
...
//			System.out.println("Configurator button is visible");
			...
			By header_totalSalesPrice = By.xpath("//*[text()='Total Sales Price']/../../../../tbody/tr/td"); 
...
//			e.printStackTrace();
	...
	public void handShake() throws InterruptedException {
		try {
			WaitTillVisible("xpath", icon_pricing_New);
...
//			By value_GroupName = By.xpath("//*[text()='" + groupName + "']");
			WaitTillVisible("xpath", "//div/div[text()='Building 1']");
...
//			By lnk_New = By.xpath("//*[text()='New']");
			WaitTillVisible("xpath", "//*[text()='New']");
			...
			WaitTillVisible("xpath", header_AddNewGroup_New_rework);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[@data-ctcname='EscalatorGroup_R']/div[1]");
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			EnterValues("xpath", "//*[@data-ctcname='GroupName_T']", groupName);
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[text()='Add:']");
			WaitTillVisible("xpath", "//*[text()='" + groupName + "']");
		} catch (Exception e) {
//			e.printStackTrace();
...
//			By lnk_releaseAll = By.xpath("//*[text()='Release all']");
			WaitTillVisible("xpath", "//*[text()='Release all']");
			List<WebElement> elements_New = gettingWebElementsfromList(By.xpath("//*[text()='New']"));
			wait.until(ExpectedConditions.visibilityOfAllElements(elements_New));
			for (WebElement element_New : elements_New) {
				if (element_New.getText().equals("New")) {
...
//			System.out.println("First maintenance: Clicked");
			...
			if (!FirstMaintenance.equals("0") && !frontlineAssigned.equals("CANADA")) {
				WaitTillVisible("xpath", header_firstMaintenance_New);
...
//								System.out.println("****TenderPrice:" + element_readTenderPrice);
	...
	public void selectingDiscount(String discount) throws Exception {
		try {
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", btn_discountOK_New); // *[@data-ctcwgtname='pbOK']
...
//		System.out.println("Double Clicked on selectingTargetPrice");
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", btn_tenderPriceOK_New);
			istenderPrice = true;
		} catch (Exception e) {
//			e.printStackTrace();
	...
	public void checkingTargetPrice() throws Exception {
		try {
			...
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='FreeMaintenancePeriod' and @value='" + firstMaintenance + "']");
...
//			By txt_editFirstMaintenanceDuration  = By.xpath("//*[@data-ctcwgtname='TMP_FreeMaintenancePeriod']");
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[@data-ctcname='FirstMaintenance_Pencil_I']");
...
//			wait.until(ExpectedConditions.not(ExpectedConditions.attributeToBeNotEmpty(element_editFirstMaintenancePrice, "value")));			
			...
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[@data-ctcwgtname='pbOK']");
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='FreeMaintenanceBase' and @value='" + isFirstMaintenancetoEdit + "']");
...
//			e.printStackTrace();
	...
	/**
	 ** Reuse method, it will return float
	 * @throws Exception
	 * @author CON_SVIJAY02
	 */
	...
	/**
	 ** Reuse method, it will return float from string
	 * @throws Exception
	 * @author CON_SVIJAY02
	 */
...
//			e.printStackTrace();
	...
	public void maximumDiscountLimitExceedPopup_Yes(String discount) {
		try {
			...
			WaitTillVisible("xpath", "//*[contains(text(),'Maximum discount limit exceeded.') or text()='" + discountformaximumDiscountLimitExceeded + ".00 %']"); //header_maximumDiscountLimitExceedPopup
//			System.out.println(gettingWebElement(maximumDiscountorDiscountPencil).getAttribute("id")+"_"+gettingWebElement(maximumDiscountorDiscountPencil).getText());
		...
		//			waitForinvisibilityOfElementLocated(elementtoInvisible);
					ClickOnElement("xpath", btn_maximumDiscountLimitExceedPopup_YES_New);
					WaitTillVisible("xpath", btn_maximumDiscountLimitExceed_SEND_New);
...
//					System.out.println(roundoff.format(TargetPriceforCheckingMaximumDiscountLimitExceeded));
		...
		//			waitForinvisibilityOfElementLocated(elementtoInvisible);			
					...
					waitForinvisibilityOfElementLocated(elementtoInvisible);
					ClickOnElement("xpath", btn_maximumDiscountLimitExceed_SEND_New);
					WaitTillVisible("xpath", header_maximumDiscountLimitExceedConfirmation_New);
					waitForinvisibilityOfElementLocated(elementtoInvisible);
					ClickOnElement("xpath", btn_maximumDiscountLimitExceedConfirmation_Ok_New);
			} else {
...
//			System.out.println(gettingWebElement(maximumDiscountorDiscountPencil).getAttribute("id")+"_"+gettingWebElement(maximumDiscountorDiscountPencil).getText());
				if(gettingWebElement(maximumDiscountorDiscountPencil).getText().contains("Maximum discount limit exceeded.")) {
					waitForinvisibilityOfElementLocated(elementtoInvisible);
					ClickOnElement("xpath", btn_maximumDiscountLimitExceedPopup_No_New);
				}
				waitForElementToBeClickable(lnk_toWord);
				GetTargetPrice();
...
//			By element_Close = By.xpath("//*[@data-ctcwgtname='close']");
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='IcInvisible']");
			scrollIntoView_Javascript(gettingWebElement(icon_Magic));
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[@data-ctcwgtname='IcInvisible']");
			WaitTillVisible("xpath", "//*[@data-ctcwgtname='ParamAllString']");
...
//			Float.valueOf(split_MaintenanceData1[0]);
			ClickOnElement("xpath", "//*[@data-ctcwgtname='close']");
			regionalDiscount = 0f;
...
//			Assert.fail("Get MaintenanceData from Page Failed");
	...
	public void getMaintenanceDatafromAutomationTest() {
		try {	
			...
			WaitTillVisible("xpath", "//*[text()='Automation test']");
			scrollIntoView_Javascript(gettingWebElement(tab_automationTest));
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[text()='Automation test']");
			WaitTillVisible("xpath", "//*[@data-ctcname='LaborRate_ID_T']");
			...
			WaitTillVisible("xpath", "//*[text()='Project Overview']");
			scrollIntoView_Javascript(gettingWebElement(tab_projectOverview));
			waitForinvisibilityOfElementLocated(elementtoInvisible);
			ClickOnElement("xpath", "//*[text()='Project Overview']");
		} catch (Exception e) {
//			e.printStackTrace();
